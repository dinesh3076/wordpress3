...
$wp_customize->add_section(
	...
	$wp_customize->add_control( 'service_4_link', array(
		'label'        => __( 'Service four Link', 'weblizar' ),
		'type'=>'url',
		'section'    => 'service_section',
	...
	$wp_customize->add_control( 'service_five_title', array(
		'label'        => __( 'Service five Title', 'weblizar' ),
		'type'=>'text',
		'section'    => 'service_section',
        ...
        array(
			'label'        => __( 'Service Icon five', 'weblizar' ),
			'description'=>__('<a href="http://fontawesome.bootstrapcheatsheets.com">FontAwesome Icons</a>','weblizar'),
            'section'  => 'service_section',
			'type'=>'text',
	...
	new enigma_Customize_Misc_Control(
        $wp_customize, 'enigma_service_options6-line',
        array(
            'section'  => 'service_section',
            'type'     => 'line'
        )
    ));
	$wp_customize->add_control( 'enigma_service_six_title', array(
		'label'        => __( 'Service six Title', 'weblizar' ),
		'type'=>'text',
		'section'    => 'service_section',
	...
	$wp_customize->add_control('enigma_options[service_6_icons]',
        array(
			'label'        => __( 'Service Icon six', 'weblizar' ),
			'description'=>__('<a href="http://fontawesome.bootstrapcheatsheets.com">FontAwesome Icons</a>','weblizar'),
            'section'  => 'service_section',
			'type'=>'text',
...
/* Portfolio Section */
	...
	for($i=1;$i<=8;$i++){
	$j = array(' One', ' Two', ' Three', ' Four',' Five', ' Six', ' Seven', ' Eight');
